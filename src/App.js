...
const SignInPage = () => {
  ...
  return (
    <div className="w-96 h-96 p-6 bg-gray-400 rounded-lg drop-shadow-lg">
      <h1 className="mb-6 text-center text-2xl font-bold">Welcome to Clamr</h1>
      <ul className="flex items-center justify-center flex-col">
        <li className="mb-3 w-full">
          ...
          >
            ...
            <span className="font-bold text-gray-500">Sign in with Google</span>
          </button>
        </li>
        <li className="mb-3 w-full">
          <button
          ...
          >
            ...
            <span className="font-bold text-white">Sign in with Facebook</span>
          </button>
        </li>
        <li className="mb-3 w-full">
          <button
